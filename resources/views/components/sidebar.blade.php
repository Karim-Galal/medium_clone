...
>
    ...
    <nav class="flex flex-col p-4 space-y-2">
        ...
        <a href="{{route('profile.show',  ['user' => auth()->user()->username])}}" class="flex items-center p-2 rounded-md   hover:text-gray-900 text-gray-700  dark:hover:text-white  dark:text-gray-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
