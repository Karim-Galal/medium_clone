                    ...
                    <ul class="flex flex-wrap justify-center  text-sm font-medium text-center text-gray-500 dark:text-gray-400 ">
                      <li class="me-2">
                          <a href="/"
                            ...
                            {{ request()->is('/') ? 'text-white bg-blue-600' : 'hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                      ...
                      @foreach ($categories as $cate)
                          <li class="me-2">
                              <a
                                href="{{route('posts.byCategory', $cate->slug)}}"
                                class="inline-block px-4 py-3 rounded-lg
                                  {{ request()->routeIs('posts.byCategory') && request()->route('category')->slug === $cate->slug
